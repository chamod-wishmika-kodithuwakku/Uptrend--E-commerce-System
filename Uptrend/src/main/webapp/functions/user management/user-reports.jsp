		...
		<div class="row inventory-dash">
			...
			<div class="col-12 col-sm-12 col-md-10">
				<div class="dashboard-body-title">
					Report 1 - Most visited users by location
				</div>
				...
				<table class="table" style="width: 40%">
					<thead class="thead-dark">
						<tr>
							...
							<th scope="col" style="width: 150px; text-align: center;">User
								Count</th>
						</tr>
					</thead>
					<c:forEach var="uReport" items="${uReport}">
						<tbody>
							<tr>
								<td>${uReport.location}</td>
								<td style="width: 150px; text-align: center;">${uReport.count}</td>
							</tr>
						</tbody>
					</c:forEach>
				</table>
