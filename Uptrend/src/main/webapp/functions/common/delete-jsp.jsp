...
<body>
	...
	<div class="p-2 container-fluid theme-bg-color">
		<div class="container" style="margin-left:6%;">
            ...
            <div class="col-12 col-sm-3 d-flex align-items-center justify-content-center home-btn-parent">
				<button type="button" class="nav-home-btn theme-bg-color"><i class="fa fa-shopping-cart" style="font-size:20px"></i>
                    
                </button>
                &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  
                <input type="image" src="avatar.png" alt="Avatar" class="avatar">
			</div>
    ...
    <div class="slideshow-container">
        ...
        <div class="d-flex justify-content-around">
          <div><h1> <button class="btn btn-primary btn-lg btn success "  onclick="location.href='Home?id='a''"><h2>Men</h2></button>  </h1></div>
          <div><h3><button class="btn info"  onclick="location.href='Home?id='b''"><h2>Women</h2></button></h3></div>
          <div><h3> <button class="btn warning"  onclick="location.href='Home?id='c''"><h2>Kids</h2></button></h3></div>
          <div><h3> <button class="btn default"  onclick="location.href='Home?id='a''"><h2>Unisex</h2></button>
          </h3></div>
        </div>
        ...
        <button>Add to Cart 8</button>
         ...
         <div class="content-body">
	         ...
	         <div class="frame">
	         	<div class="card">
				  <img src="../../resources/stock_images/jeans3.jpg" alt="Denim Jeans" style="width:100%">
				  <h1>Tailored Jeans</h1>
				  <p class="price">$19.99</p>
				  <p>Some text about the jeans..</p>
				  
				  <div class="add-to-cart"><button>Add to Cart 8</button></div>
