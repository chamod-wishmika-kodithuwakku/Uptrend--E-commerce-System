...
<body>
	...
	<div class="p-2 container-fluid theme-bg-color">
		<div class="container" style="margin-left:6%;">
            ...
            <div class="col-12 col-sm-3 d-flex align-items-center justify-content-center home-btn-parent">
                ...
                &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  
                <input type="image" src="avatar.png" alt="Avatar" class="avatar"  onclick="location.href='Login2?uName=<%= request.getParameter("user") %>'">
			</div>
    ...
    <div class="slideshow-container">
        ...
        <div class="d-flex justify-content-around">
          <div><a href="home2.jsp?id=a">Men</a></div>
          <div><a href="home2.jsp?id=b">Women</a></div>
          <div><a href="home2.jsp?id=c">Kids</a></div>
          <div><a href="home2.jsp?id=d">Unisex</a></div>
        </div>
	         ...
	         <div class="frame">
	         	<div class="card">
				  ...
				  <p>Qty: <c:out value="<%=h1.getIname() %>"/></p>
					...
					<button type="button" class="nav-home-btn theme-bg-color  button1" ><p style="font-size:20px">Add to cart</p></button>
